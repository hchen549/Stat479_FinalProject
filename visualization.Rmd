...
crime_sum = crime %>%
  ...
  filter(year == "2019" |year == "2020" | year == "2021" & month == "1" | year == "2021" & month == "2" )
...
### Navigation
The following figures analyze the relationship between zip code and crime incidents in Madison among the years from 2019 to 2021. For the map that the edge of each zip code area within Madison is enhanced and colored, the density of the area color represents the amount of crime incidents happened in the area. A right corner legend box additionally addresses the numeric percentage of incidents that connects the color of the plot. By the static bar plot, each zip code in Madison is setted as the x-axis and the total crime incidents are measured from the y-axis. Each of the bars contains crime categories classified by color and the legend below specifies the type of crime represented by the color. 
